...
simulateSIR <- function(t.end, S, I, beta, gam, maxEvents = 9999999){
     t.cur <- 0
...
sim.once <- function(t.end, S, I, beta, gam, maxEvents = 9999999){
     res = -99 # error catch
     while(res[1] == -99){
...
plot(seq(S + I), xlim = c(0,50), infectiveProbs.FFT, pch = 3,
     col = 'black', main = "Probabilities of ending with x infectives")
...
plot(seq(S+I), xlim = c(110,160), suscepProbs.FFT, pch = 3,
     col = 'black', main = "Probabilities of ending with x susceptibles")
